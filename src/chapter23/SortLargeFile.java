...
public class SortLargeFile {
	...
	private static void mergeOneStep(int numberOfSegments, int segmentSize, 
		...
		// Copy half number of segments from f1 to f2.dat
	...
	private static void displayFile(String string){
		try {
			DataInputStream input = new DataInputStream(new FileInputStream(string));
			for(int i = 0; i < 100; i++) {
